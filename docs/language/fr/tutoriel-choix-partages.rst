...
Tutoreil sur les entités : partager des listes choix entre formulaires
======================================================================

Si votre projet utilise plusieurs formulaires qui font référence aux mêmes listes de foyers, sites, produits ou autre objets d'étude, maintenir ces listes synchronisées dans tous les formualires peut s'avérer difficile. Avec les listes d'entités, vous mettez à jour les donénes une seule fois et chaque formulaire connecté restera automatiquement synchronisé, ce qui vous épargnera du temps et aidera les équipes de terrain à collecter une donnée plus précise.
Dans ce tutoriel, vous allez :ç

* Convertir des listes de choix existantes en Listes d'Entités
* Configurer les questions de type "select" afin qu'elles interrogent ces Listes d'Entités
* Ajouter des Entités directement dans Central et avec des formulaires

Nous vous recommandons de travailler dans un projet de Central dédié aux test et aux tutoriels.
